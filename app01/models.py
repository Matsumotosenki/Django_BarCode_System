...
class CodeNumbers(models.Model):
    ...
    code_name = models.CharField(verbose_name="名称", max_length=11, null=True, blank=True)
    ...
    type = models.SmallIntegerField(verbose_name="类型", choices=level_choices, default=1, null=True, blank=True)

    numbers = models.CharField(verbose_name="总数", max_length=11, null=True, blank=True)

    status_choices = (
        (1, "启用"),
        (2, "禁用")
    )
    status = models.SmallIntegerField(verbose_name="状态", choices=status_choices, default=1, null=True, blank=True)
